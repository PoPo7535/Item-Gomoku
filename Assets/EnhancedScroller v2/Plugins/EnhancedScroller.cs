...
namespace EnhancedUI.EnhancedScroller
{
    ...
    public class EnhancedScroller : MonoBehaviour, IBeginDragHandler, IEndDragHandler
    {
        ...
        public float ScrollSize
        {
            ...
            {
                if (scrollDirection == ScrollDirectionEnum.Vertical)
                    return Mathf.Max(_scrollRect.content.rect.height - _scrollRectTransform.rect.height, 0);
                else
                    return Mathf.Max(_scrollRect.content.rect.width - _scrollRectTransform.rect.width, 0);
            }
        }
        ...
        private void _Resize(bool keepPosition)
        {
            ...
            if (scrollDirection == ScrollDirectionEnum.Vertical)
                _scrollRect.content.sizeDelta = new Vector2(_scrollRect.content.sizeDelta.x, _cellViewOffsetArray.Last() + padding.top + padding.bottom);
            else
                _scrollRect.content.sizeDelta = new Vector2(_cellViewOffsetArray.Last() + padding.left + padding.right, _scrollRect.content.sizeDelta.y);
        ...
        private void _AddCellView(int cellIndex, ListPositionEnum listPosition)
        {
            ...
            cellView.transform.SetParent(_scrollRect.content, false);
            ...
            if (listPosition == ListPositionEnum.Last)
                cellView.transform.SetSiblingIndex(_scrollRect.content.childCount - 2);
